...
import { AlertTriangle, Bell, Linkedin, Trash2, Zap } from "lucide-react";
import { deleteAccount, deleteAllData, updateSettings } from "@/app/dashboard/actions";
...
export function SettingsClient({ whatsappNotifications: initialWhatsapp }: Props) {
