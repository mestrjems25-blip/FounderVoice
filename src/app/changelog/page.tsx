...
export const metadata = {
    title: "Changelog | FounderVoice AI",
    description: "Product updates and new features for FounderVoice AI.",
};
            ...
            <main className="pt-32 pb-24 flex items-center justify-center min-h-[70vh]">
                <div className="text-center px-6">
                    ...
                    <p className="text-gray-500 text-lg max-w-md mx-auto">
                        Version 1.0 of FounderVoice AI is shipping soon! Check back here for a feed of all our new features.
                    </p>
                    <div className="mt-8">
